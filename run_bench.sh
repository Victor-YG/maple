...
run(){
    sims -sys=manycore -ariane -decoupling -vlt_run $1_$2.c -x_tiles=$3 -y_tiles=1 -finish_mask=$mask -rtl_timeout=100000000 -max_cycle=15000000 -asm_diag_root=../maple -gcc_args=-DBARE_METAL -gcc_args=-DNUM_A=$4 -gcc_args=-DNUM_E=$5 -gcc_args=-DSIZE=$6 -gcc_args=-DMODE=$7 $print
